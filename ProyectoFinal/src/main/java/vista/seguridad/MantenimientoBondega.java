 ...
 * @author visitante
 */
public class MantenimientoBondega extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<Bodega> vendedor = bodegaDAO.select();
        
        tablaSedes.setModel(modelo);
        String[] dato = new String[6];
        for (int i = 0; i < vendedor.size(); i++) {
            dato[0] = Integer.toString(vendedor.get(i).getId());
            dato[1] = vendedor.get(i).getNombre();
            dato[2] = vendedor.get(i).gettipobodega();
            dato[3] = vendedor.get(i).getDireccion();
            dato[4] = vendedor.get(i).getEstado();
            modelo.addRow(dato);
        }
    }
    ...
    public void buscarVendedor() {
        ...
        BodegaAConsultar.setId(Integer.parseInt(txtbuscado.getText()));
        BodegaAConsultar = bodegaDAO.query(BodegaAConsultar);
        
        txtidVendedor.setText(String.valueOf(BodegaAConsultar.getId()));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
       BodegaDAO bodegaDAO = new BodegaDAO();
        ...
        BodegaAEliminar.setId(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        BodegaAInsertar.setId(Integer.parseInt(txtidVendedor.getText()));
        BodegaAInsertar.setNombre(txtNombre.getText());
        BodegaAInsertar.setDireccion(txtDireccion.getText());
        BodegaAInsertar.settipobodega(txtCorreo.getText());
        BodegaAInsertar.setEstado(txtEstatus.getText());
        bodegaDAO.insert(BodegaAInsertar);
        UsuarioConectado usuarioEnSesion = new UsuarioConectado();
        int resultadoBitacora=0;
        Bitacora bitacoraRegistro = new Bitacora();
        resultadoBitacora = bitacoraRegistro.setIngresarBitacora(usuarioEnSesion.getIdUsuario(), APLICACION,  "Ingreso Datos Bodega");
        llenadoDeTablas();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        BodegaDAO bodegaDAO = new BodegaDAO();
        Bodega vendedorlAActualizar = new Bodega();
        vendedorlAActualizar.setId(Integer.parseInt(txtidVendedor.getText()));
        vendedorlAActualizar.setNombre(txtNombre.getText());
        vendedorlAActualizar.setDireccion(txtDireccion.getText());
        vendedorlAActualizar.settipobodega(txtCorreo.getText());
        vendedorlAActualizar.setEstado(txtEstatus.getText());
        bodegaDAO.update(vendedorlAActualizar);
        llenadoDeTablas();
        UsuarioConectado usuarioEnSesion = new UsuarioConectado();
        int resultadoBitacora=0;
        Bitacora bitacoraRegistro = new Bitacora();
